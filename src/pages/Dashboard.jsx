...
const MODULLER = [
  { ad: 'Olay Kayıt',          aciklama: 'Yeni afet olayı kaydı oluştur',     ikon: ListPlus,   yakinda: true },
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {MODULLER.map((m) => {
            ...
            return (
              <div
                key={m.ad}
                className="card-mubil cursor-not-allowed opacity-70 transition hover:opacity-100"
              >
                <div className="flex items-start gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-mubil-50 text-mubil-700">
